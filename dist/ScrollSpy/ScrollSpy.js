    ...
    React.useEffect(function () {
        ...
        parentScrollContainerRef
            ? // if ref for scrollable div is provided
                (_a = parentScrollContainerRef.current) === null || _a === void 0 ? void 0 : _a.addEventListener("scroll", throttle.throttle(checkAndUpdateActiveScrollSpy, scrollThrottle))
            : // else listen for scroll in window
                window.addEventListener("scroll", throttle.throttle(checkAndUpdateActiveScrollSpy, scrollThrottle));
    });
